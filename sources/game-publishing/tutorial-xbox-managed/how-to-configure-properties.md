...
1. In the **Apps and games | Overview** page, select your game. Or, enter your game's name in the search bar and then select your game.
...
1. In **Product page highlights**, declare if your game supports any of the technical features listed. If none of them apply, leave this section empty. Select the information icon if you need more details.
    ...
    * Smart Delivery
    * Xbox Play Anywhere
1. In **Functionality**, define both the required and recommended technical features and specifications.
