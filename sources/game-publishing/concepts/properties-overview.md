---
title: Properties
description: Overview information for the Properties module in Partner Center.
services: gaming
author: e-h-s
ms.author: edwardst
ms.service: gaming
...
- [How to Configure Properties](../tutorial-xbox-managed/how-to-configure-properties.md).

## See also

- [Manage Packages](packages-overview.md)
- [Configure Age Ratings](age-ratings.md)
- [Configure Store Listings](store-listing.md)
- [Configure Pricing and Availability](availability/availability-overview.md)
- [Configure Gaming Metadata](metadata-overview.md)
