---
title: Microsoft Gaming Accessibility Testing Service
...
![A picture of a young girl with a mobility disability using an Xbox Adaptive Controller on a couch.](../images/gaming-accessibility/aka-MGATS-Player-with-XAC.png)
...
![A collage of four people with disabilities sitting at desks used for testing.](../images/gaming-accessibility/aka-MGATS-FourPwDTesters.png)
...
![A journey timeline of a video game going thru MGATS, showing that issues found during test that seem minor can be fixed and made into positive highlights of accessible design, or if left unadressed may lead to more serious negative sentiment from consumers.](../images/gaming-accessibility/aka-MGATS-SubmissionTimeline.png)
...
![A screenshot of the Xbox Store, which shows the tab to the Accessibility in games channel.](../images/gaming-accessibility/aka-MGATS-ACCinGamesChannel.png)
...
![A collage of children with disabilities playing games on accessibility hardware - "When everybody plays, we all win".](../images/gaming-accessibility/aka-MGATS-WeAllWin.jpg)