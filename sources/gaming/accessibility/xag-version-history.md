---
title: Xbox Accessibility Guidelines - Version History
description: The history of edits made to the Xbox Accessibility Guidelines.
ms.topic: article
ms.date: 06/8/2023
---
...
## Version 3.2 Jun 8, 2023

### XAG 102: Contrast changes

- Added an example with image.

### XAG 109: Objective clarity changes

- Added an example with two images.

### XAG 116: Time limits changes

- Added an example with two images and video link.

## Version 3.1 Oct 7, 2022

The following additions have been made to XAG 107: Input 

- A new subset of implementation guidelines and examples for touch-based input on mobile and tablet devices has been added under the heading "Guidelines for Mobile Input." 
- A new article on switch access on apple devices has been added to the "Resources and tools" section.

## Version 3.0 May 9, 2022

The following general changes have been made across all XAGs: 

- The "Gamer Personas" section has been renamed and includes the following changes: 
    - The title of this section is now called "Potential player reach" 
    - The word “Gamer” in the  “Gamer Personas” title and subsequent content will be changed to “player” to recognize the fact that not all players identify as “gamers”.
- XAG 123: Advanced Best Practices has been deprecated. Individual guidelines previously contained in XAG 123 have been moved to applicable existing XAGs.
- The following XAG Titles have been changed:  
    - XAG 105: Audio Customization will now be titled “XAG 105: Audio Accessibility” and include new guidelines that extend beyond audio customization alone (further details included in XAG 105: Audio Accessibility section of this doc).  
    - XAG 117: Visual Distractions will now be titled  “XAG 117: Visual  Distractions and Motion Settings” and contain additional information around camera angles, field of view, and other aspects of game visuals that may contribute to motion sickness (further details included in XAG 117 section of this doc).
    - XAG 123: Advanced Best Practices will now be titled “XAG 123: Mental Health Best Practices” and provide guidelines for mental health best practices (further details included in XAG 123 section of this doc).

### XAG 101: Text display changes

- Updated example images.
- Now includes guidance on how to use tools to measure text size.
- Glyph sizing guidance now aligns with guidance for text.
- Included two new implementation guidelines for font style:
...
- Updated example images and videos.
- The word "disabled" in the contrast ratio for disabled elements guideline has been changed to "inactive elements." 
- The "Contrast ratio guidance for inactive elements is now **3:1** was formerly 2.5:1.
  - Clearer guidance and examples provided for inactive elements.
- Additional clarifying note about intent of high contrast mode
- New implementation guideline for placeholder or input field text which should meet 4.5:1 contrast at standard size and 3:1 for large scale text.

### XAG 103: Additional channels for visual and audio cues changes

- Additional example video added.
- New implementation guideline added: "For text-only dialogue that is not accompanied by a spoken audio track, provide the name of the character speaking and an indication of where the speaking character is spatially located in relationship to the player’s character."

### XAG 104: Subtitles and captions changes

- New note encouraging larger minimum default text size for subtitles and captions to facilitate ease of rapid reading due to the short amount of time they are on-screen.
- The following guideline formally in the now deprecated XAG 123 Best Practices section has been added to this XAG:
...
### XAG 105: Audio accessibility changes

- Name changed from audio customization to **audio accessibility**.

### XAG 106: Screen narration changes

- Additional example videos added.
- Removed text around "facilitating compatibility between a platform screen reader and your game" from the overview.
- New implementation guideline and example captures added: "Tables should be made fully accessible to screen narration technologies."

### XAG 107: Input changes

- Added background and foundational information section detailing critical information on speed, complexity, duration, controlling game speed, remappable actions, toggles and "auto" holds.

### XAG 108: Game difficulty options

- New implementation guideline added: Provide players with the option to change difficulty at any time without losing game progress, regardless of whether they have already started the game.
- Addition of new web article and video in Resources and tools section

### XAG 109: Objective clarity

- Additional example captures added to existing guidelines

### XAG 112: UI navigation

- Additional example captures and videos added.
- Wording has been updated in the following implementation guideline to include all aspects of the game, not just the UI:
  - All aspects of the game, including menu UIs, and gameplay, are is fully navigable by multiple inputs (mouse, eye gaze, voice, keyboard, and controller).
- The following new implementation guidelines has been added:"When game map UI is scaled or zoomed in on, provide an alternative way to navigate the map that does not require scrolling, such as a supplementary text list with points of interest."

### XAG 114: UI context

- Addition of new example captures and videos.
- The word "visually" has been added to the following implementation guideline: "Labels should be visually positioned near the associated element so that the player can derive context."
- The following guideline from the now deprecated XAG 123: Advanced best practices has been moved to this XAG:
...
- The following new implementation guidelines have been added to this XAG: 
...
- The title of this XAG has been changed from "visual distractions" to "visual distractions and motion settings."
- The goal and overview section of this XAG now contains additional information about motion sickness.
- Additional scoping questions related to motion sickness inducing game mechanics or settings have been added.
- Addition of example captures and videos. 
- The following new and revised implementation guidelines have been added:
    ...
    - Avoid the use of camera shake, camera bobbing effects, motion blur, mouse blur, and more or provide an option to turn off these behaviors. (updates to wording only)

### XAG 118: Photosensitivity

- the definition of a luminance flash failure has been changed to: "A flash is defined as a 10% change in luminance (where 100% is the maximum luminance of a white screen)."

### XAG 123: Mental Health Best Practices

- This XAG, formerly listed as "Advanced best practices" has been changed to "Mental health best practices." All information in this XAG is entirely new. Guidelines that were previously in the "advanced best practices" XAG have been relocated to corresponding existing XAGs.

## Version 2.5 July 30, 2021
...
- The following note text and corresponding example was added to the implementation guideline that states: “After navigating to the last item in the UI/menu structure the player should be taken back to the first item in the UI/menu structure and vice versa.”
	...
	- NOTE: “This guideline only applies to linear menu structures where focus can be moved either up or down or left or right. Menu structures that allow focus to be moved to elements in any direction (such as a menu with focusable items arranged on a 4 &215; 4 tile) don’t need to loop.<br><br>
...
| [105](xbox-accessibility-guidelines/105.md) | Audio Customization |
...
| [117](xbox-accessibility-guidelines/117.md) | Visual Distractions |
...
| [123](xbox-accessibility-guidelines/123.md) | Advanced Best Practices |
