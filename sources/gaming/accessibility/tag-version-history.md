---
title: Accessibility Feature Tags - Version History
description: The history of edits made to the Accessibility Feature Tags.
ms.topic: article
ms.date: 3/9/2022
---


# Accessibility Feature Tags - Version History

## Version 1.0.1 (3/9/2022)

### Input: No quick-time events - Additional note

The following note was added to the Input: No quick-time events tag:

- Analog sticks and D-pad input related to character or camera movement are exempt from this requirement.

## Version 1.0 (9/30/21)

Initial version of the tags. The following tags were included:

- Additional accessibility information
- Gameplay: Accessibility on launch
- Gameplay: Adjustable Difficulty
- Gameplay: On-demand tutorials
- Gameplay: Game can be paused
