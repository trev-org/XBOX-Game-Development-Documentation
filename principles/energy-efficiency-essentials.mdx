...
See [Partner Center sustainability data](/principles/partner-center-sustainability-data) for step-by-step instructions on downloading the dataset.
...
See [Dynamic Power States](/principles/dynamic-power-states) for the full API, retail integration, and development-mode testing steps.
...
- [Sustainability PIX guide](/principles/sustainability-pix-guide)
- [Sustainability devkit guide](/principles/sustainability-devkit-guide)
- [Partner Center sustainability data](/principles/partner-center-sustainability-data)
