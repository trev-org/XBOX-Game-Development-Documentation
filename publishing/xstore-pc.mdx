...
sidebarTitle: "PC considerations overview"
icon: "windows"
...
- [XStore API reference](/reference/xstore) — `XStoreQueryGameLicenseAsync`, `XStoreQueryLicenseTokenAsync`
- [XUser API reference](/reference/xuser) — `XUserGetId`, `XUserIsStoreUser`
