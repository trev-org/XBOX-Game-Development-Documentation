...
description: "FMA scenario severities for XR-001 Title Stability, covering 001-01 Title Stability and 001-02 Title Stability After Suspending."
icon: "triangle-exclamation"
keywords: ["FMA XR-001", "title stability", "suspend resume", "IIS", "partially unresponsive", "PLS", "loading screen"]
---
...
See the [XR-001 reference](/publishing/xr/xr-001) for the underlying certification requirement.
...
- Titles under 3 GB in size with an initial play marker greater than 65% can use the reduced Probability -3 for occurrence when stability issues are encountered during streaming install. Titles outside of this threshold should start with a Probability 2 and increase as needed.
