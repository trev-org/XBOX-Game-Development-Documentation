---
title: "FMA: XR-074 Loss of Connectivity to Xbox and Partner Services"
sidebarTitle: "FMA XR-074"
description: "FMA scenario severities for XR-074 Loss of Connectivity to Xbox and Partner Services — WAN, direct, and suspended disconnections, reconnection, low bandwidth, and partner-service downtime."
icon: "wifi-slash"
keywords: ["FMA XR-074", "WAN disconnect", "suspended disconnection", "reconnection", "low bandwidth", "partner services"]
---
...
See the [XR-074 reference](/publishing/xr/xr-074) for the underlying certification requirement.
...
- Log issues observed on reconnection under Title Integrity.
- Ensure to check a title's MicrosoftGame.config for `RequiresXboxLive=true` as this value causes the system to terminate the title. This condition often applies to Online Only titles.
- Suggested probability of at least 2. Use -3 for areas of the title where the opportunity for the issue to occur is small.
