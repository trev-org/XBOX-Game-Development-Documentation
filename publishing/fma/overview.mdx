...
description: "The Xbox Certification FMA framework — severity, probability, and repeatability scoring used to consistently classify issues as CFR, SRI, or ION."
icon: "triangle-exclamation"
keywords: ["FMA", "failure mode analysis", "severity", "probability", "repeatability", "CFR", "SRI", "ION", "certification scoring"]
---

# Xbox Certification Failure Mode Analysis (FMA)

_Improving the consistency, quality, and relevance of decision making in test._
...
Severity statements take two specific forms. The first form covers most issues in focused statements. For example, _"The title exhibits moderate audio corruption/distortion following a change in headset state that detracts from the user experience."_ This style allows the test teams to accurately assign the correct category to the issue in relation to severity.

The second style is more specific. For example, _"The title ceases to output audio through either the TV or headphones following a change in headset state."_ This style captures specific behaviors that are often seen in labs, leaving no doubt as to how to assign the issue.
