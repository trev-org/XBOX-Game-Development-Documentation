---
title: "XR-123 Installation and Unlock of Game Add-Ons or Consumables During Gameplay"
sidebarTitle: "XR-123 In-session DLC"
description: "Titles that offer downloadable content must allow users to download, unlock, and use content without terminating or relaunching the game, including during suspend and constrained states."
icon: "download"
keywords: ["XR-123", "DLC", "downloadable content", "consumables", "in-game purchase", "DLC arrival", "background download", "streaming install"]
---

# XR-123: Installation and Unlock of Game Add-Ons or Consumables During Gameplay \*
...
For more information on accessing and enumerating DLC in game, read the Downloadable content (DLC) packages section of the GDK documentation.
