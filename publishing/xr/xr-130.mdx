...
sidebarTitle: "XR-130 Console Families"
description: "All game titles targeting a console generation must support the entire family of devices for that generation, including compatibility-mode behavior on Xbox Series X|S."
icon: "gamepad"
keywords: ["XR-130", "Xbox Series X|S", "Xbox One", "Smart Delivery", "cross-gen", "console family", "compatibility mode", "save roaming"]
---
