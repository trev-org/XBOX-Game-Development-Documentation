...
<Note>
  [Microsoft Store Policy 10.4.2](https://learn.microsoft.com/windows/apps/publish/store-policies#104-usability)
...
- [XR-003 Title Quality for Submission](/publishing/xr/xr-003)
