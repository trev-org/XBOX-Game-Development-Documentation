...
<Note>
  Refer to _Privacy and permissions overview_ for details on how to check and resolve privacy and permissions issues in your title.
</Note>
...
| You can communicate outside Xbox with voice and text | Manages cross-network communication | Everyone, In-game Friends, Block |
