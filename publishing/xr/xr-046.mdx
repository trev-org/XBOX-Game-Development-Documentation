...
sidebarTitle: "XR-046 Display Name"
description: "On Xbox consoles, titles must use the gamertag as their primary display name and correctly render all characters of either modern or classic gamertags."
icon: "id-badge"
keywords: ["XR-046", "gamertag", "modern gamertag", "classic gamertag", "gamerpic", "display name", "XUserGetGamertag"]
---
