...
description: "Titles must include the target user's context when linking to another app on the console, so the linked app opens with the correct signed-in user."
icon: "arrow-up-right-from-square"
keywords: ["XR-109", "app linking", "LaunchUriAsync", "LauncherOptions", "user context", "deep link", "companion app"]
---
