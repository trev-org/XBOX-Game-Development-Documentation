...
sidebarTitle: "XR-132 Service Limits"
description: "Titles that exceed title- and user-based limits or fail to follow Xbox network service retry policies may be rate-limited, potentially blocking release or resulting in service suspension."
icon: "gauge"
keywords: ["XR-132", "rate limiting", "fine-grained rate limiting", "Xbox services", "Trace Analyzer", "Fiddler", "xbtrace", "Game Event Limitations", "429", "backoff"]
---
...
- Fiddler on console or Fiddler on PC
...
4. In the GDK/XDK command prompt, run `XblTraceAnalyzer -data filepath -outputdir filepath`.
