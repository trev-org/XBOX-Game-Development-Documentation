...
Inaccurate and incomplete submissions will be rejected from Certification. Make sure to review the [Submitting to Xbox Certification in Partner Center](/publishing/submit-to-certification) documentation prior to submitting for certification. For questions related to submitting to Certification, reach out to your [Microsoft contacts](/publishing/contacts).
...
On console, audio must continue to be heard when a headset is connected, removed, and re-connected.
...
- Refer to the [console test bench guide](#console-test-bench-layout) below to set up your consoles.
- Refer to the [PC test bench guide](#pc-test-bench-layout) below to set up your PCs.
...
- [XR-001 Title Stability](/publishing/xr/xr-001)
- [XR-130 Xbox Console Families and Generations](/publishing/xr/xr-130)
