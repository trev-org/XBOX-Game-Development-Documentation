...
<Info>
  Looking for the **Microsoft Store service-to-service REST reference** (collections, purchase, clawback, grant, recurrences)? It lives in the **API** tab under [Microsoft Store REST APIs](/reference/xstore-rest-api-reference).
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Microsoft Store REST APIs" icon="code" href="/reference/xstore-rest-api-reference">
    Reference for the v8/v9 collections, purchase, clawback, grant, and recurrences endpoints. Full reference now lives in the **API** tab under [Microsoft Store REST APIs](/reference/xstore-rest-api-reference).
  </Card>
